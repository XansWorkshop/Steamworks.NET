...
namespace Steamworks {
	public static class SteamGameServerNetworkingUtils {
		...
		public static void ConvertPingLocationToString(ref SteamNetworkPingLocation_t location, out string pszBuf, int cchBufSize) {
			InteropHelp.TestIfAvailableGameServer();
			nint pszBuf2 = Marshal.AllocHGlobal(cchBufSize);
		...
		/// </summary>
		public static bool SetConfigValue(ESteamNetworkingConfigValue eValue, ESteamNetworkingConfigScope eScopeType, intptr_t scopeObj, ESteamNetworkingConfigDataType eDataType, nint pArg) {
			InteropHelp.TestIfAvailableGameServer();
		...
		/// </summary>
		public static ESteamNetworkingGetConfigValueResult GetConfigValue(ESteamNetworkingConfigValue eValue, ESteamNetworkingConfigScope eScopeType, intptr_t scopeObj, out ESteamNetworkingConfigDataType pOutDataType, nint pResult, ref ulong cbResult) {
			InteropHelp.TestIfAvailableGameServer();
		...
		public static void SteamNetworkingIPAddr_ToString(ref SteamNetworkingIPAddr addr, out string buf, uint cbBuf, bool bWithPort) {
			InteropHelp.TestIfAvailableGameServer();
			nint buf2 = Marshal.AllocHGlobal((int)cbBuf);
