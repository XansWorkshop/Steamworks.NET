...
namespace Steamworks {
	...
	public static class SteamGameServerNetworkingMessages {
		...
		/// </summary>
		public static EResult SendMessageToUser(ref SteamNetworkingIdentity identityRemote, nint pubData, uint cubData, int nSendFlags, int nRemoteChannel) {
		...
		/// </summary>
		public static int ReceiveMessagesOnChannel(int nLocalChannel, nint[] ppOutMessages, int nMaxMessages) {
			InteropHelp.TestIfAvailableGameServer();
