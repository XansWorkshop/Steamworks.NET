...
namespace Steamworks {
	...
	public static class SteamApps {
		...
		public static bool BGetDLCDataByIndex(int iDLC, out AppId_t pAppID, out bool pbAvailable, out string pchName, int cchNameBufferSize) {
			InteropHelp.TestIfAvailableClient();
			nint pchName2 = Marshal.AllocHGlobal(cchNameBufferSize);
		...
		public static uint GetAppInstallDir(AppId_t appID, out string pchFolder, uint cchFolderBufferSize) {
			InteropHelp.TestIfAvailableClient();
			nint pchFolder2 = Marshal.AllocHGlobal((int)cchFolderBufferSize);
		...
		public static int GetLaunchCommandLine(out string pszCommandLine, int cubCommandLine) {
			InteropHelp.TestIfAvailableClient();
			nint pszCommandLine2 = Marshal.AllocHGlobal(cubCommandLine);
		...
		public static bool GetBetaInfo(int iBetaIndex, out uint punFlags, out uint punBuildID, out string pchBetaName, int cchBetaName, out string pchDescription, int cchDescription) {
			InteropHelp.TestIfAvailableClient();
			nint pchBetaName2 = Marshal.AllocHGlobal(cchBetaName);
			nint pchDescription2 = Marshal.AllocHGlobal(cchDescription);
